...
* **La Gestion des transfert**, La relation Pilote-Écurie est modélisée de manière statique. Pour les pilotes ayant changé d'écurie entre 2024 et 2025 (ex: Hamilton chez Mercedes puis Ferrari), la correction est effectuée dynamiquement via des Vues SQL car nous n'avons pas trouvé de solution plus simple et viable afin de réaliser cette améliaration.
